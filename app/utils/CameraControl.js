...
CameraControl.prototype = {
    ...
    update : function()
    {
        ...
        // this.finalRadians.x += ( this.currentAngles.x * this.PI * 2 - this.finalRadians.x ) / 1;
        // this.finalRadians.y += ( this.currentAngles.y * this.PI * 2 - this.finalRadians.y ) / 1;
        this.finalRadians.x = this.currentAngles.x * this.PI * 2;
        this.finalRadians.y = this.currentAngles.y * this.PI * 2;

        //this.radius += ( this.wheelDelta - this.radius ) / 1;
